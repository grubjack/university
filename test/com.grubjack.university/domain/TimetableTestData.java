...
public class TimetableTestData {
    ...
    public static void printTimetable(Timetable timetable) {
        for (Map.Entry<DayOfWeek, TimetableUnit> entry : timetable.getUnits().entrySet()) {
            DayOfWeek dayOfWeek = entry.getKey();
            System.out.printf("======== %-10s =======\n", dayOfWeek);
            TimetableUnit unit = entry.getValue();
            for (Lesson lesson : unit.getLessons()) {
                ...
                System.out.printf("Group: %s, total %d students\n", lesson.getGroup().getName(), lesson.getGroup().getStudents().size());
    ...
    public static void printTimetableUnit(TimetableUnit unit) {
        for (Lesson lesson : unit.getLessons()) {
            System.out.printf("Subject: %s\n", lesson.getSubject());
            System.out.printf("Room: %s\n", lesson.getClassroom().getNumber());
            System.out.printf("Teacher: %s %s\n", lesson.getTeacher().getLastName(), lesson.getTeacher().getFirstName());
...
//        printTimetable(timetable);
        ...
        faculty.setTimetable(timetable);
...
//
//
//        Timetable student9tt = faculty.findStudentTimetable(student9);
//        printTimetable(student9tt);
//
//        System.out.println("********************************");

//        Timetable student2tt = faculty.findStudentTimetable(student10);
//        TimetableUnit student2tu = faculty.findStudentTimetableUnit(student2,DayOfWeek.THURSDAY);
//        printTimetable(student2tt);
//        printTimetableUnit(student2tu);
...
//
//
        Timetable teacher2tt = faculty.findTeacherTimetable(teacher1);
        printTimetable(teacher2tt);
//
